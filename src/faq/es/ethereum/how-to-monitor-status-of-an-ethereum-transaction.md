...
Apart from monitoring transaction status within Safecoinapp, users may use one of the publicly available Ethereum block explorers like [https://etherscan.io](https://etherscan.io) for monitoring as well. 
