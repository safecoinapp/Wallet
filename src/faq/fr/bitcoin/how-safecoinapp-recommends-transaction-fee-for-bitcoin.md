# How Safecoinapp recommends transaction fee for Bitcoin?

Some of the better made non-custodial wallets incl. Safecoinapp estimate the required transaction fee amount in order for the Bitcoin transaction to be included within the next block.
