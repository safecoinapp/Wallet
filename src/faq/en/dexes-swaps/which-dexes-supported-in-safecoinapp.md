# Which DEXes are supported in Safecoinapp?

Safecoinapp wallet currently supports the following decentralized exchanges:
...
In the future, Safecoinapp aims to complete integration with the [Thorchain](https://thorchain.org) decentralized exchange that enables cryptocurrency trades between blockchains.
