# How does Safecoinapp keep funds secure?

Every non-custodial wallet incl. Safecoinapp at its core is an instrument meant to securely store a wallet owner's private key(s).
...
Safecoinapp wallet stores private keys using secure storage mechanisms provided by iOS and Android operating systems.
